...
public class Kunyu77 extends Spider {
    ...
    public String detailContent(List<String> ids) {
        try {
            String url = siteUrl + "/api.php/provide/videoDetail?devid=453CA5D864457C7DB4D0EAA93DE96E66&package=com.sevenVideo.app.android&version=1.8.7&ids=" + ids.get(0);
            String content = OkHttp.string(url, getHeaders(url));
            ...
            url = siteUrl + "/api.php/provide/videoPlaylist?devid=453CA5D864457C7DB4D0EAA93DE96E66&package=com.sevenVideo.app.android&version=1.8.7&ids=" + ids.get(0);
    ...
    public String playerContent(String flag, String id, List<String> vipFlags) {
        try {
            ...
            try {
                ...
                content = OkHttp.string(jxUrl, getHeaders(jxUrl));
